...
function generate_link() {
	E("linkease_website").href = "http://" + r_lan_ipaddr + ":8899";
	if (dbus["linkease_enable"] != "1") {
		E('linkease_website').style.display = "none";
	} else {
		E('linkease_website').style.display = "";
	}
}
                                ...
                                <tr>
                                    <td bgcolor="#4D595D" colspan="3" valign="top"><div>&nbsp;</div>
                                        ...
                                        <div class="SimpleNote">
                                            <li> LinkEase支持PC、Mac、iOS、安卓、NAS和路由器平台，iOS易有云公测中：<a href="http://koolshare.cn/thread-159997-1-1.html" target="_blank"><i>http://koolshare.cn/thread-159997-1-1.html</i></a></li>
                                            <li><i>开启方法：</i>登录控制台，注册后获得Token/令牌，填入本插件，随后选择共享目录后点击提交。</li>
                                            <li><i>使用教程：</i><a href="http://koolshare.cn/thread-129199-1-1.html" target="_blank"><i>LinkEase文件同步使用教程</i></a>&nbsp;&nbsp;<a href="https://github.com/koolshare/rogsoft/blob/master/linkease/Changelog.txt" target="_blank"><em><u>[ 插件更新日志 ]</u></em></a></li>
                                            <li><i>注意事项：</i>请保护好你的ddnsto或LinkEase的Token，如果被其他人获知，那么下一个摄影大师可能就是你！！！</li>
                                        </div>
                                        <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
                                                ...
                                                <td colspan="2">
                                                    <div class="switch_field" style="display:table-cell;float: left;">
                                                        <label for="linkease_enable">
                                                            <input id="linkease_enable" class="switch" type="checkbox" style="display: none;">
                                            ...
                                            <tr>
                                                <th>Token/令牌</th>
                                                <td>
                                                    <input style="width:300px;" type="password" class="input_ss_table" id="linkease_token" name="linkease_token" maxlength="100" value="" autocomplete="new-password" autocorrect="off" autocapitalize="off" onBlur="switchType(this, false);" onFocus="switchType(this, true);">
                                                </td>
                                            </tr>
                                            <tr id="rule_update_switch">
                                                <th>管理/帮助</th>
                                                <td>
                                                    <a type="button" class="linkease_btn" href="https://www.ddnsto.com" target="_blank">登录控制台</a>
                                                    <a type="button" id="linkease_website" class="linkease_btn" href="" target="_blank" >访问LinkEase</a>
                                                </td>
                                            </tr>
                                        </table>
